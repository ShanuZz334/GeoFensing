...
be used to easily test the [3D liveness detection module](https://www.doubango.org/SDKs/face-liveness/docs/3D_passive_liveness.html). The Python API is a wrapper around the C++ API defined at [https://www.doubango.org/SDKs/face-liveness/docs/cpp-api.html](https://www.doubango.org/SDKs/face-liveness/docs/cpp-api.html).
...
python ../../../samples/python/liveness/liveness.py --assets ../../../assets --image "../../../assets/images/genuine.jpg"
```
