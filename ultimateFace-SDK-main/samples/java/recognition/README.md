...
be used to easily test the [face recognition module](https://www.doubango.org/SDKs/face-liveness/docs/Face_recognition.html). The Java API is a wrapper around the C++ API defined at [https://www.doubango.org/SDKs/face-liveness/docs/cpp-api.html](https://www.doubango.org/SDKs/face-liveness/docs/cpp-api.html).
...
This sample contains [a single Java source file](Recognition.java).

You have to navigate to the current folder (`ultimateFace-SDK/samples/java/recognition`) before trying the next commands:
```
cd ultimateFace-SDK/samples/java/recognition
```
...
`Recognition` is a command line application with the following usage:
```
Recognition \
...
java Recognition --image0 "../../../assets/images/macron-0.jpg" --image1 "../../../assets/images/macron-1.jpg" --assets ../../../assets
```
