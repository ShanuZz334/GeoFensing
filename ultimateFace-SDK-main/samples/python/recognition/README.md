...
be used to easily test the [face recognition module](https://www.doubango.org/SDKs/face-liveness/docs/Face_recognition.html). The Python API is a wrapper around the C++ API defined at [https://www.doubango.org/SDKs/face-liveness/docs/cpp-api.html](https://www.doubango.org/SDKs/face-liveness/docs/cpp-api.html).
...
`recognition.py` is a Python command line application with the following usage:
```
recognition.py \
...
```
cd ultimateFace-SDK/binaries/<<os>>/<<arch>>
```
For example:
 * On Windows x86_64: [ultimateFace-SDK/binaries/windows/x86_64](../../../binaries/windows/x86_64)
 * On Linux x86_64: [ultimateFace-SDK/binaries/linux/x86_64](../../../binaries/linux/x86_64)
 * ... you got the idea
...
python ../../../samples/python/recognition/recognition.py --assets ../../../assets --image0 "../../../assets/images/macron-0.jpg" --image1 "../../../assets/images/macron-1.jpg"
```
...
endlocal
```
If you want to make your life easier run [python_recognition.bat](../../../binaries/windows/x86_64/python_recognition.bat) to test on Windows. You can edit the file using Notepad to change the parameters.
