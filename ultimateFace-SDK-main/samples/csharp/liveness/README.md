...
be used to easily test the [3D liveness detection module](https://www.doubango.org/SDKs/face-liveness/docs/3D_passive_liveness.html). The C# API is a wrapper around the C++ API defined at [https://www.doubango.org/SDKs/face-liveness/docs/cpp-api.html](https://www.doubango.org/SDKs/face-liveness/docs/cpp-api.html).
...
`liveness.exe` is a command line application with the following usage:
```
liveness.exe \
...
```
liveness.exe ^
    --image "$(ProjectDir)..\..\..\assets\images\genuine.jpg" ^
