...
be used to easily test the [face recognition module](https://www.doubango.org/SDKs/face-liveness/docs/Face_recognition.html). The C# API is a wrapper around the C++ API defined at [https://www.doubango.org/SDKs/face-liveness/docs/cpp-api.html](https://www.doubango.org/SDKs/face-liveness/docs/cpp-api.html).
...
You'll need Visual Studio to build the code. The VS project is at [liveness.csproj](liveness.csproj). Open it.
 - You will need to change the **"Command line arguments"** like the [below image](../../../VCsharp_config.jpg). Default value: `--assets "$(ProjectDir)..\..\..\assets" --image "$(ProjectDir)..\..\..\assets\images\genuine.jpg"`
...
`recognition.exe` is a command line application with the following usage:
```
recognition.exe \
...
```
recognition.exe ^
    --image0 "$(ProjectDir)..\..\..\assets\images\macron-0.jpg" ^
    --image1 "$(ProjectDir)..\..\..\assets\images\macron-1.jpg" ^
